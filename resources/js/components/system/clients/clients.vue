    ...
    <div class="bg-gray-100">
        <div class="p-6 w-3/5 bg-white shadow-md rounded-md mx-auto mt-12">
            <div class="flex justify-center items-center">
                <h1 class="text-gray-700 font-bold text-2xl">Clientes</h1>
            </div>

            <div class="flex justify-between mt-4">
                <h2 class="text-lg font-bold text-gray-700">Listado de clientes</h2>
                <router-link to="/clients/create">
                    <button type="button" class="py-2 px-4 text-center bg-blue-500 rounded-md text-white hover:bg-blue-600">Nuevo cliente</button>
                </router-link>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr v-for="item in items" :key="items.id">
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                            <router-link :to="`/clients/update/${ item.id }`" class="text-indigo-600 hover:text-indigo-900">
                                Editar
                            </router-link>
                            &nbsp;&nbsp;
